...
class Newsapp:
    def __init__(self):
        # fetch data
        self.data = requests.get('https://newsapi.org/v2/top-headlines?country=in&apiKey=1f37a5129664493dac3eab408c9aa0ee').json()
    ...
    def load_news_item(self,index):
        ...
        try:
            ...
            img_url = 'https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcR2eZm41kcM3R7-Ckgiyq4SeDCtuWB2DldZFA&usqp=CAU'
            raw_data = urlopen(img_url).read()
            im = Image.open(io.BytesIO(raw_data)).resize((350, 250))
            photo = ImageTk.PhotoImage(im)
